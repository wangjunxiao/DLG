...
args.target_id = 0 # image dataset index
...
#defs = core.strategy.training_strategy('conservative') # training strategy
...
if __name__ == "__main__":
    ...
    # Get data:
    loss_fn, trainloader, validloader = data.dataloader.load_dataset(dataset=args.dataset, data_path=arg.data_path)
    print('-------------------------------')
